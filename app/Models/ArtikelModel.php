...
class ArtikelModel extends Model
{
    ...
    protected $allowedFields = ['id_artikel', 'judul_artikel', 'judul_artikel_en', 'foto_artikel', 'deskripsi_artikel', 'deskripsi_artikel_en', 'meta_title_artikel', 'meta_description_artikel','slug_id','slug_en','meta_title_artikel_en','meta_description_artikel_en'];
